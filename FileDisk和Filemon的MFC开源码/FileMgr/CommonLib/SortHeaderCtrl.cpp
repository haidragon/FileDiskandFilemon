...
void CSortHeaderCtrl::DrawItem( LPDRAWITEMSTRUCT lpDrawItemStruct )
{
	...
	// draw the background,
	COLORREF colorBackgroud = GetSysColor(COLOR_3DFACE);
	//CBrush brush(GetSysColor(COLOR_3DFACE));
	CBrush brush;
	//if( lpDrawItemStruct->itemID == (UINT)m_iSortColumn )
	//	colorBackgroud = RGB(255, 128, 255);
	//else
	//	colorBackgroud = GetSysColor(COLOR_3DFACE);
	brush.CreateSolidBrush(colorBackgroud);
